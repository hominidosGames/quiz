...
<div class="min-h-screen flex items-center justify-center">
    <div class="max-w-md  p-6 bg-purple-100 rounded-lg shadow-lg w-70">
      <div class="flex justify-center mb-8">
        <div class="w-40">
            <img src="../../../assets/images/logoMainMenu.gif"/>
        </div>
      ...
      <form @submit.prevent="login">
        <div class="mb-6">
          ...
          <input type="email" id="userEmail" name="email" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500" required>
        </div>
        <div class="mb-6">
      ...
      <p class="text-xs text-gray-600 text-center mt-10">&copy; 2024 MANIACOS GAMES</p>
    </div>
  </div>
</div>
</template>
